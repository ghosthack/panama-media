...
public class _GUID {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        d3d11video_h.C_LONG.withName("Data1"),
        d3d11video_h.C_SHORT.withName("Data2"),
        d3d11video_h.C_SHORT.withName("Data3"),
        MemoryLayout.sequenceLayout(8, d3d11video_h.C_CHAR).withName("Data4")
    ).withName("_GUID");
